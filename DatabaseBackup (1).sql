...
--
-- Temporary view structure for view `driver_person_rating`
--

DROP TABLE IF EXISTS `driver_person_rating`;
/*!50001 DROP VIEW IF EXISTS `driver_person_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `driver_person_rating` AS SELECT 
 1 AS `person_name`,
 1 AS `driver_id`,
 1 AS `license_number`,
 1 AS `number_of_rate`,
 1 AS `ontime_rating`,
 1 AS `courteous_rating`*/;
...
INSERT INTO `driver_rating` VALUES (1,4,4,2,64),(2,1,2,1,37),(3,2,5,3,55),(4,3,3,7,33),(5,3,2,6,90),(6,2,2,7,63),(7,2,5,8,72),(8,3,4,4,92),(9,4,1,8,29),(10,5,5,4,37),(11,3,3,8,56),(12,3,5,3,97),(13,2,5,6,55),(14,2,3,6,46),(15,3,5,4,22),(16,4,3,6,38),(17,5,3,8,47),(18,5,3,2,50),(19,5,3,8,69),(20,1,5,5,15),(21,4,5,4,11),(22,4,4,1,60),(23,2,2,7,10),(24,4,5,3,66),(25,1,3,4,3),(26,1,5,6,8),(27,4,3,4,19),(28,3,2,2,28),(29,3,2,2,90),(30,1,5,2,4),(31,5,2,3,92),(32,4,4,3,64),(33,3,4,4,81),(34,2,2,1,26),(35,2,2,4,29),(36,1,3,5,49),(37,4,3,8,4),(38,2,5,3,54),(39,5,3,6,33),(40,2,3,3,28),(41,4,4,7,99),(42,2,2,2,7),(43,2,4,1,63),(44,2,1,6,77),(45,3,4,2,100),(46,1,3,8,69),(47,1,2,8,60),(48,4,1,6,87),(49,3,3,6,35),(50,5,4,7,87),(51,1,3,8,26),(52,2,4,4,15),(53,1,2,4,15),(54,3,1,1,94),(55,1,1,6,3),(56,1,5,3,71),(57,3,2,4,30),(58,3,1,3,52),(59,1,3,2,12),(60,2,2,8,90),(61,4,5,6,13),(62,2,2,5,12),(63,5,3,8,17),(64,5,4,8,18),(65,5,3,8,92),(66,3,5,7,29),(67,1,2,7,1),(68,1,2,7,79),(69,3,2,6,94),(70,2,1,2,62),(71,1,5,2,57),(72,3,2,3,18),(73,1,4,7,43),(74,2,5,5,100),(75,3,3,5,62),(76,3,3,3,68),(77,4,5,5,54),(78,5,2,5,42),(79,3,5,2,75),(80,5,5,2,77),(81,4,1,6,17),(82,1,2,2,5),(83,4,1,4,18),(84,1,1,7,51),(85,5,4,8,94),(86,2,4,5,27),(87,3,5,1,75),(88,2,2,1,81),(89,3,1,2,77),(90,5,4,7,100),(91,5,2,5,11),(92,5,2,4,45),(93,2,3,1,81),(94,5,4,8,18),(95,5,4,3,23),(96,5,5,2,80),(97,4,2,5,59),(98,5,4,1,56),(99,3,5,6,20),(100,2,2,7,55);
...
CREATE TABLE `foods` (
  ...
  `food_calorie` int(11) DEFAULT NULL,
...
--
-- Temporary view structure for view `order_person_rating`
--

DROP TABLE IF EXISTS `order_person_rating`;
/*!50001 DROP VIEW IF EXISTS `order_person_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `order_person_rating` AS SELECT 
 1 AS `order_id`,
 1 AS `person_name`,
...
INSERT INTO `orders` VALUES (1,1,1,1,1,15.63,6.63),(2,2,2,2,2,18.03,9.43),(3,3,3,3,3,11.91,7.42),(4,4,4,4,4,19.13,6.26),(5,5,5,5,5,13.76,6.24),(6,6,6,6,6,5.4,4.83),(7,7,7,7,7,14.05,8.57),(8,8,8,8,8,3.81,2.38),(9,9,9,9,9,17.1,6.72),(10,10,10,10,10,12.71,1.82),(11,11,11,11,11,3.9,7.26),(12,12,12,12,12,6.82,7.4),(13,13,13,13,13,4.73,7.43),(14,14,14,14,14,12.08,1.21),(15,15,15,15,15,3.83,4.77),(16,16,16,16,16,12.43,2.76),(17,17,17,17,17,6.61,4.85),(18,18,18,18,18,7.89,5.69),(19,19,19,19,19,16.54,4.88),(20,20,20,20,20,3.21,4.98),(21,21,21,21,21,5.19,4.17),(22,22,22,22,22,19,1.39),(23,23,23,23,23,14.5,3.28),(24,24,24,24,24,11.81,2.71),(25,25,25,25,25,6.83,4.85),(26,26,26,26,26,7.24,5.65),(27,27,27,27,27,10.56,1.73),(28,28,28,28,28,4.25,4.98),(29,29,29,29,29,6.68,8.66),(30,30,30,30,30,14.5,6.47),(31,31,31,31,31,14.92,9.53),(32,32,32,32,32,4.12,9.42),(33,33,33,33,33,7.02,7.99),(34,34,34,34,34,8.6,6.69),(35,35,35,35,35,8.98,4.72),(36,36,36,36,36,7.94,4.78),(37,37,37,37,37,14.8,2.13),(38,38,38,38,38,19.05,6.61),(39,39,39,39,39,12.49,5.97),(40,40,40,40,40,15.56,6.01),(41,41,41,41,41,8.85,7.06),(42,42,42,42,42,12.28,5.52),(43,43,43,43,43,9.28,9.63),(44,44,44,44,44,9.78,8),(45,45,45,45,45,12.43,5.11),(46,46,46,46,46,4.11,9.65),(47,47,47,47,47,14.29,6.65),(48,48,48,48,48,5.69,3.31),(49,49,49,49,49,12.52,6.38),(50,50,50,50,50,8.84,9.92),(51,51,51,51,51,5.69,1.5),(52,52,52,52,52,14.53,4.58),(53,53,53,53,53,10.23,3.61),(54,54,54,54,54,10.7,7.36),(55,55,55,55,55,14.03,8.66),(56,56,56,56,56,13.46,1.26),(57,57,57,57,57,13.98,8.85),(58,58,58,58,58,15.21,6.59),(59,59,59,59,59,4.6,8.25),(60,60,60,60,60,3.27,6.39),(61,61,61,61,61,9.39,2.63),(62,62,62,62,62,3.7,2.47),(63,63,63,63,63,18.49,7.01),(64,64,64,64,64,15.51,8.26),(65,65,65,65,65,6.8,9.41),(66,66,66,66,66,12.57,1.88),(67,67,67,67,67,8.69,6.21),(68,68,68,68,68,9.38,9.56),(69,69,69,69,69,18.23,3.89),(70,70,70,70,70,13.39,9.65),(71,71,71,71,71,17.71,3.01),(72,72,72,72,72,10.59,2.03),(73,73,73,73,73,6.99,9.8),(74,74,74,74,74,14.14,3.98),(75,75,75,75,75,16.73,7.27),(76,76,76,76,76,6.64,5.09),(77,77,77,77,77,16.48,1.15),(78,78,78,78,78,18.61,6.49),(79,79,79,79,79,18.66,8.19),(80,80,80,80,80,7.6,9.54),(81,81,81,81,81,16.72,4.05),(82,82,82,82,82,5.64,7.18),(83,83,83,83,83,7.39,9.14),(84,84,84,84,84,11.61,1.57),(85,85,85,85,85,16.74,8.84),(86,86,86,86,86,19.88,2.43),(87,87,87,87,87,7.52,4.32),(88,88,88,88,88,14.63,4.4),(89,89,89,89,89,19.45,9.89),(90,90,90,90,90,12.5,8.23),(91,91,91,91,91,10.34,3.69),(92,92,92,92,92,11.34,6.34),(93,93,93,93,93,15.05,8.26),(94,94,94,94,94,7.89,7.05),(95,95,95,95,95,16.69,9.19),(96,96,96,96,96,5.71,8.39),(97,97,97,97,97,16.9,9.15),(98,98,98,98,98,15.63,8.92),(99,99,99,99,99,3.71,2.53),(100,100,100,100,100,5.08,2.74),(101,1,2,3,5,6,1);
...
--
-- Temporary view structure for view `person_rating`
--

DROP TABLE IF EXISTS `person_rating`;
/*!50001 DROP VIEW IF EXISTS `person_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `person_rating` AS SELECT 
 1 AS `person_name`,
 1 AS `cell`,
 1 AS `person_kind`,
 1 AS `title`,
...
INSERT INTO `ratings` VALUES (1,4,4),(2,3,12),(3,4,13),(4,4,17),(5,5,41),(6,4,47),(7,4,11),(8,5,42),(9,5,37),(10,1,28),(11,2,37),(12,5,45),(13,4,9),(14,3,46),(15,5,14),(16,2,16),(17,3,6),(18,5,12),(19,5,46),(20,5,23),(21,3,17),(22,1,14),(23,5,19),(24,2,37),(25,2,43),(26,1,8),(27,4,31),(28,5,35),(29,1,16),(30,3,39),(31,3,3),(32,1,45),(33,4,29),(34,4,7),(35,5,21),(36,4,36),(37,3,15),(38,3,30),(39,5,4),(40,5,42),(41,1,47),(42,5,27),(43,4,25),(44,2,16),(45,2,30),(46,4,12),(47,1,40),(48,2,33),(49,5,46),(50,1,22),(51,5,16),(52,1,27),(53,4,37),(54,2,8),(55,4,19),(56,5,41),(57,3,48),(58,2,7),(59,2,19),(60,2,25),(61,2,28),(62,4,36),(63,3,25),(64,5,49),(65,4,37),(66,1,1),(67,1,20),(68,5,16),(69,1,26),(70,3,19),(71,5,49),(72,2,17),(73,1,30),(74,5,41),(75,3,33),(76,2,42),(77,4,13),(78,1,48),(79,4,20),(80,3,43),(81,1,47),(82,5,12),(83,4,20),(84,1,47),(85,3,17),(86,4,45),(87,2,48),(88,3,4),(89,4,5),(90,3,18),(91,1,16),(92,5,42),(93,5,20),(94,5,7),(95,4,47),(96,5,35),(97,4,18),(98,5,27),(99,1,11),(100,2,29),(101,3,68),(102,2,91),(103,1,73),(104,5,55),(105,1,80),(106,4,76),(107,2,55),(108,1,77),(109,1,60),(110,4,80),(111,3,83),(112,2,56),(113,3,65),(114,1,59),(115,2,62),(116,2,83),(117,5,53),(118,4,78),(119,4,86),(120,5,68),(121,5,80),(122,4,84),(123,5,78),(124,3,80),(125,3,58),(126,4,60),(127,2,68),(128,5,97),(129,5,63),(130,3,96),(131,3,54),(132,1,99),(133,2,96),(134,3,93),(135,2,76),(136,3,76),(137,5,69),(138,4,61),(139,5,92),(140,5,82),(141,3,81),(142,2,82),(143,4,55),(144,3,70),(145,4,77),(146,1,68),(147,3,86),(148,3,55),(149,5,90),(150,3,57),(151,3,95),(152,5,93),(153,1,74),(154,4,59),(155,2,99),(156,3,99),(157,3,52),(158,5,89),(159,5,69),(160,2,61),(161,2,55),(162,5,51),(163,4,73),(164,4,81),(165,3,93),(166,3,52),(167,3,96),(168,5,80),(169,2,96),(170,2,80),(171,2,92),(172,3,58),(173,3,88),(174,1,78),(175,4,95),(176,5,58),(177,2,54),(178,4,52),(179,2,89),(180,3,88),(181,3,70),(182,5,54),(183,4,52),(184,1,72),(185,1,92),(186,4,60),(187,3,91),(188,2,84),(189,3,59),(190,2,53),(191,2,88),(192,3,52),(193,5,82),(194,4,69),(195,2,67);
...
INSERT INTO `restaurant` VALUES (1,'5357 Adrianna Shoal Suite 418\nEnochside, OH 46739-1915','Rath Ltd','9am -10pm','http://hahn.com/',NULL,1),(2,'6977 Adams Locks Suite 001\nErikastad, LA 55321-5793','Kerluke-Herman','11am - 11pm','http://wilderman.com/',NULL,1),(3,'559 Robin Cape\nWest Merl, OH 31271-9957','Berge Inc','11am - 11pm','http://okunevarohan.com/',NULL,1),(4,'4501 Labadie Via\nLake America, NJ 33290','Hamill, Prohaska and Lehner','10am - 9pm','http://jacobswilderman.info/',NULL,1),(5,'5587 Fanny Port\nNorth Nigel, NC 05813','Ratke LLC','10am - 9pm','http://www.williamson.org/',NULL,1),(6,'3906 Wilkinson Street Suite 611\nLake Moisesburgh, DE 83148','Fisher-Rempel','9am -10pm','http://www.lehner.net/',NULL,1),(7,'459 Labadie Course Suite 026\nNorth Ola, ND 60631','Ryan, Jaskolski and Schinner','10am - 9pm','http://www.schuster.org/',NULL,1),(8,'630 Block Harbors\nEast Rudolphhaven, LA 44638','Kub, Borer and Ward','11am - 11pm','http://klingprohaska.com/',NULL,1),(9,'40616 Mante Islands\nSouth Gileschester, MI 75466','O\'Conner-Mraz','9am -10pm','http://www.rosenbaum.com/',NULL,1),(10,'9015 Velma Junction\nSpencerland, KY 15821-5602','Mayert LLC','9am -10pm','http://www.raynorgoldner.com/',NULL,1),(11,'48482 Bode Harbors\nPort Modesta, AZ 10082-7993','Grady, Kreiger and Frami','10am - 9pm','http://skiles.com/',NULL,1),(12,'597 Leora Summit Apt. 714\nEbertbury, WI 48130-6262','Abbott-Schmitt','9am -10pm','http://feil.com/',NULL,1),(13,'387 Tromp Estates Suite 445\nWest Leopoldshire, NC 80009','Ankunding Group','9am -10pm','http://www.balistreri.info/',NULL,1),(14,'679 Russel Villages\nConnellyfort, MD 72266','Weber, Lehner and Mueller','9am -10pm','http://mccullough.com/',NULL,1),(15,'177 Katrina Gateway Apt. 797\nJastport, MN 44988-2805','Connelly, Wolf and Murazik','10am - 9pm','http://mraz.com/',NULL,1),(16,'3136 Kunde Ports Apt. 399\nLake Trevor, CO 19002','Abernathy, Lehner and Zulauf','10am - 9pm','http://kirlinkulas.com/',NULL,1),(17,'03334 Blanda Trafficway Suite 568\nFloyfort, OK 34900-7724','Heathcote, Kovacek and Cummerata','9am -10pm','http://glover.biz/',NULL,1),(18,'031 Milton Bypass Suite 952\nStephonburgh, WY 82916-7389','Hauck, Rodriguez and Cremin','11am - 11pm','http://reynolds.com/',NULL,1),(19,'375 Alanna Crossroad Suite 259\nNorth Shanna, MN 54873','Hermiston-Purdy','11am - 11pm','http://herzog.com/',NULL,1),(20,'9359 Marcos Park Apt. 091\nSchmitttown, IL 68853','Smitham-Haley','11am - 11pm','http://quitzonmckenzie.com/',NULL,1),(21,'215 Shanon Creek\nEast Antonettaview, MN 74167-8029','Cruickshank-Reilly','10am - 9pm','http://rodriguezkshlerin.com/',NULL,1),(22,'0562 Cassin Divide\nElenorafurt, AR 37048','Eichmann-Casper','10am - 9pm','http://www.farrell.biz/',NULL,1),(23,'41925 Bosco Station Apt. 238\nSouth Clara, MA 87547-3817','Gorczany, Kuphal and Pouros','9am -10pm','http://www.dare.com/',NULL,1),(24,'9119 Cummerata Avenue Suite 529\nAbshiremouth, ND 00145-7770','Moen Ltd','9am -10pm','http://www.eichmannhomenick.org/',NULL,1),(25,'422 Lesch Common Apt. 940\nNew Felicitaborough, IL 21308-3053','Keeling, Maggio and Hirthe','10am - 9pm','http://hermannwalter.info/',NULL,1),(26,'52787 Ullrich Locks\nReynoldsside, IA 48689-5885','Mraz, Reichel and Hermiston','11am - 11pm','http://www.runolfsdottir.com/',NULL,1),(27,'1135 Bartell Islands\nLake Philipton, HI 43588-0971','Oberbrunner-Herman','10am - 9pm','http://www.rice.com/',NULL,1),(28,'8279 Concepcion Center\nHauckshire, AL 83821','Stanton-D\'Amore','9am -10pm','http://nienow.com/',NULL,1),(29,'283 Nadia Islands\nAudreanneburgh, GA 64125-4442','Waelchi LLC','11am - 11pm','http://www.littel.net/',NULL,1),(30,'093 Fredrick Spurs\nSouth Shannamouth, RI 24292','Ziemann, Denesik and Kunze','10am - 9pm','http://www.klinghilll.info/',NULL,1),(31,'3948 Kiehn Forest Apt. 782\nHageneschester, VT 94419','Tromp Ltd','9am -10pm','http://white.com/',NULL,1),(32,'4652 Maeve Brook\nSouth Corine, WA 21701-5426','Beatty Ltd','11am - 11pm','http://parisian.biz/',NULL,1),(33,'4863 Becker Spring\nNorth Candelarioburgh, UT 16649-1046','Gutmann LLC','10am - 9pm','http://beahan.net/',NULL,1),(34,'46083 Mekhi Ridge\nLake Jerrodhaven, VT 38507-5949','Macejkovic Ltd','9am -10pm','http://www.beahan.com/',NULL,1),(35,'214 Lyric Mission\nPort Meaganview, AR 17033','Rolfson LLC','9am -10pm','http://skiles.com/',NULL,1),(36,'96083 Konopelski Isle Suite 006\nBruenfort, KY 49444-9497','Marquardt, Reinger and Gusikowski','11am - 11pm','http://www.daniel.com/',NULL,1),(37,'213 Larkin Coves\nQuintonside, TX 07955','Harber Group','10am - 9pm','http://www.goodwin.biz/',NULL,1),(38,'0859 Hills Pine Apt. 888\nMyriammouth, NM 69940-8316','Wuckert, Reilly and Wuckert','9am -10pm','http://www.boscokilback.com/',NULL,1),(39,'67511 Graham Shore\nLaceyland, WI 78493','Kirlin, Gibson and Kovacek','9am -10pm','http://schinner.com/',NULL,1),(40,'0416 Nyasia Hills\nWest Penelope, MA 56613','Morissette, Kutch and Spinka','11am - 11pm','http://www.smitham.biz/',NULL,1),(41,'6044 Prohaska Oval\nWillton, MI 09742','Corkery, Kilback and Skiles','10am - 9pm','http://www.schumm.com/',NULL,1),(42,'0561 Dora Manors Suite 455\nNew Aliamouth, CO 28487-7002','Huels-Considine','11am - 11pm','http://dareboehm.biz/',NULL,1),(43,'719 Virgil Orchard Apt. 083\nSouth Amalia, KY 78515-9294','Gusikowski, Funk and Rau','10am - 9pm','http://www.johnston.org/',NULL,1),(44,'8474 Joana Rest\nNorth Kariane, MI 13273-8980','Friesen, Zemlak and Runolfsson','9am -10pm','http://www.schillerstreich.org/',NULL,1),(45,'85504 Jacky Radial Suite 460\nBeauberg, ND 20689','Hayes-O\'Hara','9am -10pm','http://www.feest.net/',NULL,1),(46,'791 Lennie Tunnel Apt. 153\nTyreekshire, DC 94328','Sporer, Reinger and Runte','10am - 9pm','http://www.gerhold.com/',NULL,1),(47,'269 Keeling Forks\nBauchfort, TN 32390-9816','Rutherford, Cummerata and Langosh','10am - 9pm','http://pacocha.net/',NULL,1),(48,'976 Gislason Heights Suite 926\nChristiansenshire, FL 00995','McGlynn PLC','10am - 9pm','http://langoshmcclure.com/',NULL,1),(49,'3227 Witting Landing\nFerrystad, WY 43540','Crooks, Corkery and Dickinson','11am - 11pm','http://hudson.com/',NULL,1),(50,'59694 Ulises Ranch Apt. 292\nRobelhaven, NY 81549','Jenkins-Greenholt','11am - 11pm','http://feil.net/',NULL,1),(51,'71811 Gertrude Via Suite 007\nSouth Taryn, NV 23967','Waters, Turner and Adams','9am -10pm','http://franeckikuhn.com/',NULL,1),(52,'09615 Green Shores Suite 103\nJaquanmouth, VA 66615','Hilpert, Von and Frami','11am - 11pm','http://gloverhansen.com/',NULL,1),(53,'7385 Douglas Rapid\nLake Eusebioberg, NV 04724','Larkin, Lakin and Huel','11am - 11pm','http://www.pfeffer.com/',NULL,1),(54,'121 Hartmann Falls Apt. 221\nEast Ashleyshire, CT 19450','Cremin Ltd','10am - 9pm','http://davis.com/',NULL,1),(55,'9775 Victoria Inlet\nWest Clifford, NV 16309-4617','Orn, Kshlerin and Ebert','10am - 9pm','http://www.wisokywilderman.net/',NULL,1),(56,'983 Macie Squares Apt. 211\nEast Lyda, PA 70725','Keeling-Jaskolski','11am - 11pm','http://doyle.com/',NULL,1),(57,'801 Strosin Village\nDouglasbury, WY 85892','Kuhn-Kuhn','10am - 9pm','http://www.blick.com/',NULL,1),(58,'162 Renner Walk\nNew Lexie, IN 72766','Runolfsdottir-Hagenes','9am -10pm','http://hickle.info/',NULL,1),(59,'207 Berge Turnpike\nNorth Bulah, NY 56382-2747','Bradtke, Johnston and Baumbach','11am - 11pm','http://jones.org/',NULL,1),(60,'93126 O\'Reilly Stream\nSouth Reneebury, NE 37534','Schulist-Dickinson','9am -10pm','http://www.huels.net/',NULL,1),(61,'7027 Harold Vista Apt. 309\nSouth Lamarchester, AK 74002','Rath, Lebsack and Hane','10am - 9pm','http://www.sawayn.com/',NULL,1),(62,'070 Valerie Radial\nLake Geraldine, ID 66048','Botsford Inc','9am -10pm','http://kesslergreenholt.com/',NULL,1),(63,'83563 Gabe Cliffs Suite 176\nMurraybury, MI 42637-0699','Klocko and Sons','9am -10pm','http://cruickshankhahn.org/',NULL,1),(64,'65258 Nelle Bypass Apt. 441\nNew Noemie, OR 56221-2401','Greenfelder-Strosin','11am - 11pm','http://www.quitzon.com/',NULL,1),(65,'392 Terry Common\nReneeburgh, GA 16078-5698','Volkman Group','10am - 9pm','http://hansen.com/',NULL,1),(66,'58362 Weimann View Apt. 783\nBorertown, IA 93172','Stanton-Marvin','10am - 9pm','http://johns.org/',NULL,1),(67,'7339 Ziemann Common\nWest Diamondport, NC 14355-1563','Huels, Schamberger and Volkman','9am -10pm','http://www.greenholtlittle.com/',NULL,1),(68,'172 Daisy Overpass\nFeestbury, MI 69119','Bahringer, Herman and Lebsack','10am - 9pm','http://www.reichert.info/',NULL,1),(69,'744 Trudie Row Apt. 555\nLake Eduardoport, AL 24252-6634','Von and Sons','9am -10pm','http://www.buckridge.com/',NULL,1),(70,'0420 Waelchi Ferry\nCedrickberg, KY 95033-5914','Daniel PLC','11am - 11pm','http://www.barton.com/',NULL,1),(71,'90000 Pinkie Summit\nSouth Ansleyport, NJ 05455','Daniel, Ledner and Keebler','9am -10pm','http://swift.com/',NULL,1),(72,'267 Kemmer Dam Suite 757\nLake Shanna, ND 06978-8017','Shields-Wehner','9am -10pm','http://maggiowisozk.com/',NULL,1),(73,'5242 Maymie Prairie\nJosephinechester, CT 08166','Davis-Gottlieb','10am - 9pm','http://kiehn.com/',NULL,1),(74,'503 Halvorson Roads\nEmilianomouth, WY 48846','Kuhic, DuBuque and Rutherford','10am - 9pm','http://mcdermott.com/',NULL,1),(75,'61619 White Lock\nKassulkeberg, SD 92407','Miller-Schuppe','9am -10pm','http://langworth.net/',NULL,1),(76,'2686 Rosina Drives\nLake Irving, WI 93674','Marquardt and Sons','9am -10pm','http://schoen.info/',NULL,1),(77,'665 Reba Field Suite 259\nAbbieville, HI 45209','Heller-Stoltenberg','10am - 9pm','http://keebler.net/',NULL,1),(78,'274 Aniyah View\nCorkerybury, NJ 42353-0485','Kub-Bartoletti','10am - 9pm','http://www.walkerschuster.biz/',NULL,1),(79,'136 Champlin Circles Suite 260\nElmiraburgh, NY 86723','Pollich-Connelly','10am - 9pm','http://quigleyjohns.com/',NULL,1),(80,'6656 Durgan Glens\nSidneyfort, NY 23527-3946','Predovic Group','11am - 11pm','http://www.mcclure.info/',NULL,1),(81,'916 Kenna Walks Apt. 224\nDomenichaven, SD 08585','Thiel-Paucek','11am - 11pm','http://www.klein.com/',NULL,1),(82,'87162 Keven Wall\nNew Amya, GA 23801-4982','Bednar and Sons','10am - 9pm','http://hamill.org/',NULL,1),(83,'32020 Langworth Way\nJaycefort, MT 55909','Sipes-Carroll','9am -10pm','http://larkin.net/',NULL,1),(84,'198 Mazie Bypass Apt. 852\nPort Newellland, ID 46813-6856','Kohler-Predovic','10am - 9pm','http://hermiston.com/',NULL,1),(85,'8170 Orn Pine\nJadonton, MN 06564-1919','Fisher, Yundt and Wiegand','10am - 9pm','http://friesen.com/',NULL,1),(86,'6809 Kulas Circles Suite 622\nPort Leonieland, KS 31358-9888','Corwin Inc','10am - 9pm','http://turner.com/',NULL,1),(87,'540 Maximillia Via Suite 247\nNew Christine, OH 16149-9776','Veum PLC','10am - 9pm','http://www.shields.biz/',NULL,1),(88,'8085 Alvina Isle Apt. 893\nJamisonland, MD 06507','Barrows Group','10am - 9pm','http://www.marquardtschumm.com/',NULL,1),(89,'7446 Jarrett Plaza\nNew Phoebeview, ME 25224','Kub, Hoeger and Swaniawski','10am - 9pm','http://www.haley.biz/',NULL,1),(90,'631 Wilkinson Shoal Apt. 785\nMadisynbury, NE 51948','Kerluke-Flatley','11am - 11pm','http://www.waters.net/',NULL,1),(91,'86467 Kshlerin Point\nHeathcotetown, AZ 27728-4616','Rowe, Pouros and Gutkowski','11am - 11pm','http://gerlach.com/',NULL,1),(92,'92578 Kylie Trafficway Suite 755\nLake Murphy, GA 78904','Grimes-Sporer','9am -10pm','http://www.osinski.com/',NULL,1),(93,'72392 Hahn Station Apt. 674\nWest Josianeside, MT 59330-3244','Price-Reinger','11am - 11pm','http://stoltenbergmohr.biz/',NULL,1),(94,'9329 Vesta Harbors Suite 849\nUllrichchester, DC 53814','Boehm, White and Kilback','9am -10pm','http://www.hillljohnson.com/',NULL,1),(95,'30248 Eichmann Street Suite 151\nLake Nelson, VT 78923-5543','Conroy-O\'Keefe','10am - 9pm','http://hermiston.org/',NULL,1),(96,'1070 Green Forks\nSelenaland, VT 70941','Wiegand LLC','9am -10pm','http://www.streich.com/',NULL,1),(97,'20073 Clyde Ways Suite 898\nWest Dejahchester, GA 59632','Donnelly and Sons','10am - 9pm','http://cummings.net/',NULL,1),(98,'215 Altenwerth Mall Apt. 621\nDietrichberg, MI 96944','McDermott, Senger and Ferry','10am - 9pm','http://www.collins.net/',NULL,1),(99,'1105 Liza Shores Apt. 158\nHermannland, GA 62111','Grimes-Lakin','9am -10pm','http://terry.net/',NULL,1),(100,'88626 Louvenia Fork\nLake Maxiefurt, TN 43522','Mertz Ltd','9am -10pm','http://ortiz.com/',NULL,1);
...
INSERT INTO `restaurant_rating` VALUES (1,3,1,26,97),(2,4,1,2,40),(3,2,2,3,92),(4,4,2,48,67),(5,5,5,40,25),(6,1,4,6,3),(7,2,1,27,67),(8,1,1,18,61),(9,5,1,4,51),(10,1,4,31,51),(11,2,3,22,27),(12,1,3,15,61),(13,5,5,45,77),(14,5,3,15,58),(15,5,4,38,27),(16,2,5,2,66),(17,5,4,27,96),(18,5,2,42,50),(19,3,1,33,21),(20,3,4,42,96),(21,1,5,6,71),(22,2,1,4,54),(23,5,2,11,66),(24,2,1,44,86),(25,4,2,47,67),(26,4,3,12,54),(27,5,4,13,21),(28,4,1,3,5),(29,1,3,10,46),(30,1,5,35,22),(31,2,4,19,88),(32,5,2,2,13),(33,2,2,42,28),(34,5,1,39,12),(35,5,3,43,38),(36,2,4,4,58),(37,4,4,26,22),(38,3,1,30,68),(39,4,2,31,17),(40,4,5,44,41),(41,5,4,33,51),(42,4,2,36,3),(43,1,4,27,14),(44,5,2,6,6),(45,2,1,16,1),(46,2,1,44,92),(47,2,4,45,1),(48,2,1,42,92),(49,3,5,45,87),(50,1,5,30,6),(51,3,4,9,81),(52,5,4,28,42),(53,2,4,48,85),(54,4,4,27,42),(55,3,3,42,47),(56,1,5,1,39),(57,3,4,23,64),(58,2,2,21,89),(59,3,5,24,19),(60,4,4,12,4),(61,1,3,15,44),(62,4,3,18,5),(63,4,5,28,38),(64,3,5,15,78),(65,4,4,41,86),(66,3,2,39,19),(67,5,2,18,26),(68,1,5,47,10),(69,2,4,16,84),(70,2,3,18,54),(71,5,2,45,43),(72,1,4,33,88),(73,4,5,4,58),(74,4,1,18,29),(75,1,5,15,36),(76,1,3,19,37),(77,1,4,29,30),(78,1,4,9,51),(79,2,3,5,51),(80,4,5,1,79),(81,4,4,35,33),(82,3,2,25,34),(83,1,5,23,76),(84,3,5,15,40),(85,4,4,9,2),(86,5,5,29,18),(87,1,5,47,27),(88,4,1,41,34),(89,3,3,35,35),(90,1,1,34,21),(91,1,4,46,14),(92,1,4,12,2),(93,3,3,38,67),(94,1,3,37,44),(95,2,4,47,32),(96,2,1,35,48),(97,4,3,10,3),(98,4,1,21,24),(99,3,4,48,100),(100,3,1,37,86),(101,4,1,60,54),(102,1,1,63,36),(103,4,3,93,5),(104,5,4,69,100),(105,3,5,55,62),(106,2,5,52,81),(107,4,5,88,10),(108,4,5,80,49),(109,3,1,87,10),(110,1,4,97,67),(111,5,4,76,36),(112,2,2,73,87),(113,5,1,52,15),(114,4,5,52,99),(115,1,1,89,46),(116,1,3,54,78),(117,3,5,81,16),(118,2,5,70,100),(119,5,5,56,38),(120,4,5,82,25),(121,4,2,74,4),(122,3,5,96,15),(123,4,4,60,37),(124,2,2,74,26),(125,1,2,94,83),(126,3,3,53,50),(127,3,4,94,15),(128,1,2,88,87),(129,5,3,59,32),(130,2,5,83,94),(131,4,2,83,58),(132,5,4,86,2),(133,3,3,79,19),(134,2,1,63,26),(135,3,4,100,100),(136,1,2,86,38),(137,1,2,66,69),(138,5,3,96,65),(139,1,5,87,77),(140,1,1,68,53),(141,3,1,96,2),(142,5,5,52,87),(143,2,3,71,12),(144,4,1,92,48),(145,2,5,85,67),(146,3,4,79,75),(147,2,2,65,8),(148,2,3,82,85),(149,4,2,68,24),(150,3,2,61,94),(151,3,1,68,55),(152,4,2,74,76),(153,2,5,82,69),(154,5,1,72,20),(155,2,2,86,80),(156,1,4,52,58),(157,4,2,63,15),(158,1,2,58,9),(159,2,2,51,68),(160,3,4,84,17),(161,5,2,65,82),(162,4,5,68,62),(163,5,5,72,7),(164,3,5,93,85),(165,2,1,95,55),(166,3,3,67,19),(167,3,3,61,36),(168,4,3,69,42),(169,5,5,97,29),(170,1,3,74,12),(171,5,3,100,88),(172,1,1,59,82),(173,5,5,51,79),(174,1,2,69,10),(175,2,5,58,81),(176,1,5,97,37),(177,3,1,79,71),(178,5,3,81,7),(179,1,4,53,42),(180,3,1,93,73),(181,1,2,87,98),(182,1,1,91,65),(183,3,1,99,44),(184,5,4,53,24),(185,4,5,98,59),(186,3,3,54,54),(187,4,4,97,82),(188,3,4,82,69),(189,5,1,54,45),(190,1,5,93,74),(191,5,1,54,3),(192,5,2,69,74),(193,3,3,54,37),(194,2,3,69,94),(195,2,2,80,26),(196,2,1,78,94),(197,2,5,74,9),(198,3,3,93,33),(199,4,3,83,26),(200,5,2,62,62);
...
--
-- Final view structure for view `driver_person_rating`
--
...
/*!50001 VIEW `driver_person_rating` AS select `p`.`person_name` AS `person_name`,`d`.`driver_id` AS `driver_id`,`d`.`license_number` AS `license_number`,`r`.`no_rate` AS `number_of_rate`,`r`.`ontime_rating` AS `ontime_rating`,`r`.`courteous_rating` AS `courteous_rating` from (((`campus_eats_fall2020`.`driver` `d` left join `campus_eats_fall2020`.`student` `s` on((`s`.`student_id` = `d`.`student_id`))) left join `campus_eats_fall2020`.`person` `p` on((`p`.`person_id` = `s`.`person_id`))) left join (select `campus_eats_fall2020`.`driver_rating`.`driver_id` AS `driver_id`,count(0) AS `no_rate`,round(avg(`campus_eats_fall2020`.`driver_rating`.`ontime_rating`),2) AS `ontime_rating`,round(avg(`campus_eats_fall2020`.`driver_rating`.`courteous_rating`),2) AS `courteous_rating` from `campus_eats_fall2020`.`driver_rating` group by `campus_eats_fall2020`.`driver_rating`.`driver_id`) `r` on((`r`.`driver_id` = `d`.`driver_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `order_person_rating`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `order_person_rating` AS select `o`.`order_id` AS `order_id`,`p`.`person_name` AS `person_name`,`l`.`location_address` AS `location_address`,date_format(`d`.`delivery_time`,'%W %M %e %Y') AS `delivery_date`,cast(`d`.`delivery_time` as time) AS `delivery_time`,ifnull(`r`.`overall_rating`,'No Rate') AS `overall_rating` from ((((`campus_eats_fall2020`.`orders` `o` join `campus_eats_fall2020`.`person` `p` on((`p`.`person_id` = `o`.`person_id`))) left join `campus_eats_fall2020`.`location` `l` on((`l`.`location_id` = `o`.`location_id`))) left join (select `campus_eats_fall2020`.`ratings`.`order_id` AS `order_id`,round(avg(`campus_eats_fall2020`.`ratings`.`overall_rating`),2) AS `overall_rating` from `campus_eats_fall2020`.`ratings` group by `campus_eats_fall2020`.`ratings`.`order_id`) `r` on((`r`.`order_id` = `o`.`order_id`))) left join `campus_eats_fall2020`.`delivery` `d` on((`d`.`delivery_id` = `o`.`delivery_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `person_rating`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `person_rating` AS select `p`.`person_name` AS `person_name`,`p`.`cell` AS `cell`,(case when (`f`.`faculty_id` is not null) then 'Faculty' when (`st`.`student_id` is not null) then 'Student' when (`s`.`staff_id` is not null) then 'Staff' else 'Other' end) AS `person_kind`,ifnull((case when (`f`.`faculty_id` is not null) then concat(`f`.`title`,' - ',`f`.`highest_degree`,' degree from ',`f`.`degree_college`) when (`st`.`student_id` is not null) then concat(`f`.`title`,' - ',`st`.`type`,' of ',`st`.`major`) when (`s`.`staff_id` is not null) then `s`.`position` else 'Not Defined' end),'Whitout Title') AS `title`,ifnull(`rate`.`price_rating`,'No Rate') AS `price_rating`,ifnull(`rate`.`food_rating`,'No Rate') AS `food_rating`,ifnull(`rate`.`courteous_rating`,'No Rate') AS `courteous_rating`,ifnull(`rate`.`ontime_rating`,'No Rate') AS `ontime_rating` from ((((`campus_eats_fall2020`.`person` `p` left join `campus_eats_fall2020`.`faculty` `f` on((`f`.`person_id` = `p`.`person_id`))) left join `campus_eats_fall2020`.`student` `st` on((`st`.`person_id` = `p`.`person_id`))) left join `campus_eats_fall2020`.`staff` `s` on((`s`.`person_id` = `p`.`person_id`))) left join (select `o`.`person_id` AS `person_id`,round(avg(`rr`.`price_rating`),2) AS `price_rating`,round(avg(`rr`.`food_rating`),2) AS `food_rating`,round(avg(`dr`.`courteous_rating`),2) AS `courteous_rating`,round(avg(`dr`.`ontime_rating`),2) AS `ontime_rating` from ((`campus_eats_fall2020`.`orders` `o` left join `campus_eats_fall2020`.`restaurant_rating` `rr` on((`rr`.`order_id` = `o`.`order_id`))) left join `campus_eats_fall2020`.`driver_rating` `dr` on((`dr`.`order_id` = `o`.`order_id`))) group by `o`.`person_id`) `rate` on((`rate`.`person_id` = `p`.`person_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-04-03 12:07:52
